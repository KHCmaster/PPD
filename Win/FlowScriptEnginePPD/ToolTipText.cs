...
namespace FlowScriptEnginePPD
{
    public class ToolTipText : IToolTipText
    {
        ...
        {
            this.key = summary;
            this.summary = FlowScriptEnginePPD.Properties.Resources.ResourceManager.GetString(summary);
        ...
        public ToolTipText(string summary, string remark)
        {
            this.key = summary;
            this.summary = FlowScriptEnginePPD.Properties.Resources.ResourceManager.GetString(summary);
            this.remark = FlowScriptEnginePPD.Properties.Resources.ResourceManager.GetString(remark);
            toolTipText = this.summary + "\n" + this.remark;
        }
