...
{
    partial class InstallAbortedPanel
    {
        /// <summary> 
        /// 必要なデザイナ変数です。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.label4.Size = new System.Drawing.Size(373, 101);
            this.label4.TabIndex = 5;
            this.label4.Text = "PPD、および関連ソフトのインストールは中断されました。プログラムをインストールする際には、再度このプログラムを実行してください。終了ボタンを押すことでセットアッ" +
                "プを終了します。";
            // 
            // label3
            // 
            ...
            this.label3.Text = "インストールは中断されました";
            // 
            // InstallAbortedPanel
            // 
