    ...
    class ModPanel : FocusableGameComponent
    {
        ...
        private void Reload(int selectIndex = -1)
        {
            ...
            foreach (var modInfo in currentModInfo.Children)
            {
                ...
                {
                    modListSprite.AddChild(new ModInfoComponent(device, resourceManager, (ModInfo)modInfo)
                    {
                        Position = new Vector2(0, iter * 30),
                        Hidden = iter >= MaxDisplayCount
                    });
        ...
        public class ModInfoComponent : ModInfoComponentBase
        {
            ...
            public ModInfoComponent(PPDDevice device, PPDFramework.Resource.ResourceManager resourceManager, ModInfo modInfo)
                : base(device, modInfo)
            {
            ...
            public override void UpdateInfo()
            {
                ...
                availableRanking.Hidden = ModInfo.ContainsModifyData;
            }
