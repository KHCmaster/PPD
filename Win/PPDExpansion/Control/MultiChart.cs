...
namespace PPDExpansion.Control
{
    public class MultiChart : Chart
    {
        ...
        public MultiChart()
        {
            ...
            _sourceChanged.CollectionChanged += sourceCollectionChanged_CollectionChanged;
        }
        ...
        private void CreateSeries(object item, int index)
        {
            ...
            if (dataTemplate != null)
            {
                ...
                if (dataTemplate.LoadContent() is Series series)
                {
                    // set data context
